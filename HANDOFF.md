...
- Selection highlight should remain visible without becoming overly thick; small selections use a slim yellow stick highlight, while very large selections may fall back to a yellow line overlay to keep the UI responsive.
