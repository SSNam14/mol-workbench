...
- MAE/MAEGZ conversion must preserve Maestro bond order metadata as entry `bondOrders` alongside the converted PDB text. This keeps double-bond line display available after conversion even though PDB `CONECT` itself cannot encode bond order.
