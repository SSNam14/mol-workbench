...
function boot(){
  ...
  function proteinBackboneStyleSpec(){
    ...
    return {cartoon:{colorfunc:chainRibbonColor,thickness:0.15,loopWidth:0.25,helixTension:0.80,sheetTension:0.80,arrows:true,arrowWidth:1.15,arrowLength:1.0}};
  }
